...
import { PequerecetasError, invalidInput, notFound } from "../../src/errors.js";
...
describe("toToolError", () => {
  ...
  it("turns a value that is not a PequerecetasError into a network_error keeping its message", () => {
  ...
  it("keeps a PequerecetasError apart from an ordinary Error", () => {
    expect(notFound("x")).toBeInstanceOf(PequerecetasError);
    expect(new Error("x")).not.toBeInstanceOf(PequerecetasError);
  });
});
