...
[Security → Report a vulnerability](https://github.com/smeet666/mcp-pequerecetas/security/advisories/new).
...
A read-only client for Pequerecetas. It needs no API key and no account, it
